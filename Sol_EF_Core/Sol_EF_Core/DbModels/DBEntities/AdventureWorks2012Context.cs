...
namespace Sol_EF_Core.DbModels.DBEntities
{
    public partial class AdventureWorks2012Context : DbContext
    {
        ...
        public virtual DbSet<UdvSales> UdvSales { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-MOL1H66\\IDEATORS;Initial Catalog=AdventureWorks2012;Integrated Security=True;Connect Timeout=60;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AwbuildVersion>(entity =>
            {
                ...
                entity.HasComment("Current version number of the AdventureWorks 2012 sample database. ");
            ...
            modelBuilder.Entity<UdvSales>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("udvSales");
                ...
                entity.Property(e => e.TotalUnitPrice).HasColumnType("money");
            });
